...
def modo_voz(status_callback=None):
...
def processar_comando(comando, usar_voz=False):
    ...
    if _processar_recursos(mensagem, usar_voz):
    ...
    if bate(
        ...
        resposta = "Desligando os sistemas. Até logo, senhor."
...
def iniciar_assistente(status_callback=None):
    ...
    while True:
        ...
        if modo == "espera":
            ...
            resultado = modo_voz(status_callback)
